package self.sunng.miscellaneous.poi;
...
/**
 * Created by sunxiaodong on 2017/9/18.
 */
public class PoiWord {

    public static void main(String[] args) throws Exception {
        new PoiWord().testWriteTable();
    }
    /**
     * 基本的写操作
     * @throws Exception
    ...
    public void testSimpleWrite() throws Exception {
        ...
        run.setColor("FF0000");
        run.setText("红色的字。");
        OutputStream os = new FileOutputStream("/Users/abc/Desktop/simpleWrite.docx");
        //把doc输出到输出流
        doc.write(os);
        this.close(os);
    }
...
//       List<CTTc> list = row.getCtRow().getTcList();
        ...
        //文件不存在时会自动创建
        OutputStream os = new FileOutputStream("/Users/abc/Desktop/writeTable.docx");
        //写入文件
        doc.write(os);
        this.close(os);
    }
