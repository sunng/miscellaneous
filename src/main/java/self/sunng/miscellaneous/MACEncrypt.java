...
/**
 * Created by sunxiaodong on 2017/2/7.
 */
public class MACEncrypt {
    ...
    public static void main(String[] args) throws Exception {
        ...
        byte[] keyHmacMD5 = MACEncrypt.initHmacMD5Key();
        System.out.println(MACEncrypt.encodeHmacMD5(testString.getBytes(), keyHmacMD5));

        byte[] keyHmacSHA1 = MACEncrypt.initHmacSHAKey();
        System.out.println(MACEncrypt.encodeHmacSHA(testString.getBytes(), keyHmacSHA1));

        byte[] keyHmacSHA256 = MACEncrypt.initHmacSHA256Key();
        System.out.println(MACEncrypt.encodeHmacSHA256(testString.getBytes(), keyHmacSHA256));

        byte[] keyHmacSHA384 = MACEncrypt.initHmacSHA384Key();
        System.out.println(MACEncrypt.encodeHmacSHA384(testString.getBytes(), keyHmacSHA384));

        byte[] keyHmacSHA512 = MACEncrypt.initHmacSHA512Key();
        System.out.println(MACEncrypt.encodeHmacSHA512(testString.getBytes(), keyHmacSHA512));
    }
